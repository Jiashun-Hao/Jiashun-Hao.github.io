...
- 其实`Thread`类也是实现与`Runnable`接口的，在加上Java有着单继承多实现的特性，所以第二种方法要优于第一种；![在这里插入图片描述](images/blog_migrate_c035f4306845e2b3cde31e216aa966fa_png.png)
- 无论那种方法都必须重写`run()`方法，并且完成工作的代码段需要放到里面；![在这里插入图片描述](images/blog_migrate_cfa371a288449085e9fb44031f501506_png.png)
- 多线程的启动方式为`对象.start()`,而不能使用`对象.run()`,否则将失去多线程的效果![在这里插入图片描述](images/blog_migrate_5dd2cdf285f5a5bf36fd04e76edc878d_png.png)
...
运行结果：  
 ![在这里插入图片描述](images/blog_migrate_add689bcc6aef32ada53aea49a6585c5_png.png)  
 也可以使用匿名对象来实现：
...
![在这里插入图片描述](images/blog_migrate_9919c3d8b5048cc492b9a483867b6f72_png.png)
...
![在这里插入图片描述](images/blog_migrate_680792860be0ba141cf4db0f61d140ac_png.png)  
 也可以使用匿名对象来实现：
...
![在这里插入图片描述](images/blog_migrate_d40cda4a0e8b6b9690bdf409b440499d_png.png)
...
- 实现的方法更适合用来处理**共享数据**的问题，所直接创建的对象并不是一个线程，必须将其传入到Thread中对象才能运行，各个对象是否使用一个Runnable成员对象视情况而定；![在这里插入图片描述](images/blog_migrate_355eb28c1667cfceddce5a1570f75c2e_png.png)
...
![在这里插入图片描述](images/20201024103900406_png.png)
...
上面所练习的两种方法均存在错误——当线程抢到CPU资源后如果没有来得及**执行当前代码程序**便被挂起，当下一个线程进入后仍然可以操作**执行当前代码程序**  
 ![在这里插入图片描述](images/blog_migrate_66aba32ae155bdad359dae2115b63a76_png.png)  
...
运行结果：  
 ![在这里插入图片描述](images/blog_migrate_f679f8840d726eb066d4a918969a34f6_png.png)  
   
  
 解决方法：使用`join()`方法；  
 ![在这里插入图片描述](images/blog_migrate_8a8efc34ec6e9be603bb11c6101b23db_png.png)
...
运行结果：  
 ![在这里插入图片描述](images/blog_migrate_dde699296cc43bbdf809440d45df109a_png.png)  
...
![在这里插入图片描述](images/blog_migrate_767dcbad7f98694afa6576d53cfd7026_png.png)
...
运行结果：  
 ![在这里插入图片描述](images/blog_migrate_6272b0bf349b2d3e3c143a4c7a61045c_png.png)

## 四、线程通信

### 4.1线程通信用到的方法

![在这里插入图片描述](images/blog_migrate_86c175423764c52ccb585552aa4b7c0e_png.png)

### 4.2练习

![在这里插入图片描述](images/blog_migrate_34bd11bfa36b9a182aa7e1a114a8509a_png.png)
...
**题目**：  
 ![在这里插入图片描述](images/blog_migrate_0bc34962ddefbf9200308f66983435ce_png.png)
...
运行结果：  
 ![在这里插入图片描述](images/blog_migrate_ad60edb7d8f0b5986fce2e59b18836c4_png.png)
