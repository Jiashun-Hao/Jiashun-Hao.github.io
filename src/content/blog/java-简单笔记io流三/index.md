...
description: "为了后面这两个重要的流，再单独开一篇。 - [一、对象流](- [二、RandomAccessFile类]( 作用： 传输对象（引用数据类型）    特点："
...
2.使用**对象流**可以将对象存储到硬盘中，断电后不消失，所使用的机制称为**序列化机制**；  
 ![在这里插入图片描述](./images/63ac08ed7c1a07e3c04e034f1560f71b.png.jpg)  
...
- **凡是实现Serializable接口的类必须声明一个版本的序列号serialVersionUID,默认情况下序列号会随生成，但是为了兼容版本的特性，最好自己声明；**  
   ![在这里插入图片描述](./images/76aaa97dc523e6738ac9cf7b4417ad9e.png.jpg)
...
![在这里插入图片描述](./images/54b953f8168d3b58701e0fc8dce5f8fb.png.jpg)
...
- void seek(long pos)：将文件记录指针定位到 pos 位置  
   ![在这里插入图片描述](./images/ef5153abf1d78ab57ae6ebb966afeb8a.png.jpg)
- 如果想使用该类，必须先使用该类的构造器创建对象  
   ![在这里插入图片描述](./images/45393f6e97cc5695dff3a31c8e6b5aea.png.jpg)
...
1.实现覆盖效果：  
 ![在这里插入图片描述](./images/8e032ad3cccf7cb6876038c3a0a208b6.png.jpg)
...
![在这里插入图片描述](./images/2e8825171c1921a9b8afa3747c24aa3b.png.jpg)
...
![在这里插入图片描述](./images/2be2191dee53dbabd023316b8f289c29.png.jpg)

3.多行文本插入效果（保留换行符）  
 ![在这里插入图片描述](./images/0c60906208057057efdbecd4e6b4bc0a.png.jpg)
...
![在这里插入图片描述](./images/8dde8e4b2f0ff9f0df7b2856603b1f6d.png.jpg)
