...
description: "设计模式（Design pattern）是一套被反复使用、多数人知晓的、经过分类编目的、代码设计经验的总结。使用设计模式是为了可重用代码、让代码更容易被他人理解"
publishDate: 2020-02-29
tags: []
# 原文链接: https://blog.csdn.net/HJS1453100406/article/details/104578502
---
#### 什么是设计模式？
...
![在这里插入图片描述](./images/4bb09b066f15ebfdf913e11b3abc39d9.png)
...
输出结果：  
![在这里插入图片描述](./images/5cb47d2492aa9f8a92a3ff1c5b40626b.png)
