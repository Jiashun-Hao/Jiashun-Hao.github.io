...
description: "- [一、缓冲流](- - - [1.字节缓冲流的使用](    - [2.补充](    - [3.字符缓冲流（BufferedReader和Buffered"
...
1.由于缓冲流起到是是一种包装的作用，所以直接关闭缓冲流的对象即可；  
 2.先关闭输入，再关闭输出；  
 ![在这里插入图片描述](./images/27b88fead7f4993c4829fbd715888805.png.jpg)  
 3.需要在try-catch以外先声明缓冲流，并赋值为null；  
 ![在这里插入图片描述](./images/6ff7c1745c5fd36458be2dcf21853232.png.jpg)  
 4.在使用缓冲流 ***完成写入*** 以后，最好使用`.flush()`方法清空一下缓存区；其原因在于当输入、输出流被关闭时候仍然有可能有一部分数据在缓冲区，我们需要强制输出一下；  
 ![在这里插入图片描述](./images/66839caae2ab88f6596ebdee01407229.png.jpg)
...
![在这里插入图片描述](./images/8cab88adf933d9d024f60a20cb922d42.png.jpg)
...
![在这里插入图片描述](./images/76376137072c411ea3e0949b3bdb67f8.png.jpg)

在这两个流的构造器中需要传递两个参数：**要进行编/解码的文件**和**编码集（charstName）**；

所谓编码集就是进行编码/解码的格式集合，常用的有以下几种；

![在这里插入图片描述](./images/58b003222f33278bca93f4ccd81db84e.png.jpg)  
 并且，**编码集按照字符串的格式输入：**  
 ![在这里插入图片描述](./images/d2c475dc5a9573c966085e4ce61f63e4.png.jpg)
...
源文件：  
 ![在这里插入图片描述](./images/fdd0a57f4c946202bc3a0c9a2f13bfb9.png.jpg)  
 解码后：  
 ![在这里插入图片描述](./images/75a1e6f68627f8574b6e7bd84494c8b3.png.jpg)
...
编码后写入：  
 ![在这里插入图片描述](./images/726a99e2b8e46244d50f8a31de5ccb1f.png.jpg)
...
![在这里插入图片描述](./images/5e1ec499f3e9918ae189560eddc19d87.png.jpg)
 ...
 **配图：**  
 ![在这里插入图片描述](./images/04efad6449f97a385d659f782a1c44e8.png.jpg)  
 使用：
...
![在这里插入图片描述](./images/3e41487d333f4285a3ed000db4856f73.png.jpg)  
 ![在这里插入图片描述](./images/fdeec0d6accf5edeee65abc6a6d7e886.png.jpg)