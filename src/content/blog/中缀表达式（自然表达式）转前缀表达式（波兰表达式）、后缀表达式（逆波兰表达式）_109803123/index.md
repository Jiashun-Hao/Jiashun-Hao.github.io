...
description: '中缀表达式（自然表达式）转前缀表达式（波兰表达式）、后缀表达式（逆波兰表达式）'
tags:
  - 算法
language: 'Chinese'
---
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1a53ffb2c5aa1879d7720ce1c68c4355.png#pic_center)
...
![](https://i-blog.csdnimg.cn/blog_migrate/d3c69c47de0f549e8ef9d69e17b96e1a.png#pic_center)
#### 3.2后缀表达式计算：
后缀表达式的计算机求值：
与前缀表达式类似，只是顺序是从左至右：
