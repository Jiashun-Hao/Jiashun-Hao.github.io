...
![在这里插入图片描述](images/blog_migrate_2d31d498e4176d8790552f821ada2a3e_png.png)
...
![在这里插入图片描述](images/blog_migrate_4b545fd741cb9c0ef28418fb346b28fb_png.png)
...
![在这里插入图片描述](images/blog_migrate_95d2251a5ef689dae16495ae4bd2dbdc_png.png)  
结果：  
![在这里插入图片描述](images/blog_migrate_0e0cd7f24657636208a27699c870d972_png.png)  
（2）如果文件中不止一个类，而且没有public类，文件名可与任一类名一致。  
![在这里插入图片描述](images/blog_migrate_7d5cc24c990d85ee51a56f3d3cab99b7_png.png)  
...
![在这里插入图片描述](images/blog_migrate_92aca2772632cb01fab7deab80f49dbc_png.png)  
并不是这样，其实判断Java的主类并不是去寻找public class，而是去寻找**和文件名一样的类名**它所对应的类，就是Java的主类  
![在这里插入图片描述](images/blog_migrate_3e00ab668110372f7ca92b928aa78a56_png.png)  
