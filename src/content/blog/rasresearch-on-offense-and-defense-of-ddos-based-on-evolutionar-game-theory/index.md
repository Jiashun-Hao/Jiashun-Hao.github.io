---
title: "RAS《Research on Offense and Defense of DDos Based on Evol..."
description: "- [Ⅰ：Read abstract(阅读摘要)](- - [0：Proper noun interpretation（专有名词解释）](  - [1：The"
...
- - [0：Proper noun interpretation（专有名词解释）](#0Proper_noun_interpretation_2)
  - [1：The question raised by this paper（本文提出的问题）](#1The_question_raised_by_this_paper_14)
  - [2：The Novel solution in the paper（论文中创新的解决方法）](#2The_Novel_solution_in_the_paper_20)
  - [3：Experimental process（实验过程）](#3Experimental_process_25)
  - [4：The final result（最终得出的结果）](#4The_final_result_65)
...
 在一定条件下，遵循一定的规则，一个或几个拥有**绝对理性**思维的人或者团队，从各自允许的选择的行为或策略进行选择并加以实施，并从中各自取得相应结果或收益的过程。
...
 假设4:攻击者有两种策略:“攻击”和“不攻击”。“攻击”和“不攻击”的概率分别为y(0≤y≤1)和1−y。  
 根据这些假设，作者生成了决策描述图。  
 ![在这里插入图片描述](./images/fefad4e0bcefe57d6a36b815755b23bf.png)  
...
![在这里插入图片描述](./images/beee76a36f39d9033618b4fb646faf92.png)  
 ![在这里插入图片描述](./images/955afa3f8cae501e99183a2732a34142.png)
...
 攻击方更倾向于发起攻击，防御方的策略选择与主动防御系统的成本有关（这不是废话吗？？？？？）  
 ![在这里插入图片描述](./images/5f3acba9feb05f61d56286032e75afa0.png)