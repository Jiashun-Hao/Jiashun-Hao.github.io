---
title: "Mysql数据库使用命令"
description: "- [DDL数据定义语言](- - [一、数据库](  - - [1.创建数据库](    - [2.选择数据库](    - [3.删除数据库](  - [二"
...
- - [一、数据库](#_4)
  ...
  - - [1.插入记录](#1_86)
    ...
    - [6.条件查询](#6_113)
    - [7.模糊条件查询](#7_117)
    - [8.查询字段的值是否在列表内](#8_128)
    - [9.查询字段的值是否在范围内](#9_132)
    - [10.查询值为空（NULL）的字段](#10NULL_136)
    - [11.查询结果排序](#11_148)
  - [四、常用函数](#_162)
  - - [1.统计行数](#1_163)
    - [2.分组前查询](#2_169)
  ...
  - - [1.多表等值连接](#1_186)
  - [六、SQL99语法](#SQL99_203)
  - - [1.SQL99与SQL92区别](#1SQL99SQL92_204)
    - - [1.1内连接](#11_208)
      - [1.2外连接](#12_222)
  - [七、子查询](#_235)
  - - [1.子查询规范](#1_236)
