...
description: "序言：首先说明一点，其实本篇主要是叙述面向对象三要素之一的“多态”，但是我发现我好像没有专门写和“封装”有关的博客，在加上我目前理解的层次水平不是很高，才疏学浅"
publishDate: 2020-02-20
tags: []
# 原文链接: https://blog.csdn.net/HJS1453100406/article/details/104418764
---
...
嗯，按理说这时候`xiaoming` 这个对象被实例化了，可以使用`对象.属性/方法`使用，但是，真的是这样吗？  
 ![](./images/6257e6a4a710bd3acb33321d5b6f0ff5.png)  
 可以看到，此时的`xiaoming`并不能直接调用该类中的属性，为什么？  
 原因在于age和name前面的修饰符，public：  
 ![在这里插入图片描述](./images/702ed457b2403cb90ebc040112c859b9.png)  
...
输出结果：  
 ![在这里插入图片描述](./images/3e0a11930b49e6a28629fbdd764b10f3.png)  
 over~~
...
我们试着调出`xiao`的属性和方法，看看它到底具有那些属性和方法；  
 如图：  
 ![在这里插入图片描述](./images/56a8857dbb167a9b5b331c2313b1bd5c.png)  
...
输出结果：  
 ![在这里插入图片描述](./images/ffc79fb850aac33bcc95c6372b0ae74e.png)  
...
使用第二行代码以后。我们可以看到，对象`hua`具有了子类的全部属性，包括’id’;  
 ![在这里插入图片描述](./images/51f46b18350db3595a3c698086a07fa7.png)  
 **2.必要的几点说明：**  
 1.同为一个父类多个子类，不能相互转换；  
...
结果：  
 ![在这里插入图片描述](./images/93f61edb85a7fab223a7428bec9f94d9.png)  
...
结果：  
 ![在这里插入图片描述](./images/70a338a71be59dd0bb4567e1e481b471.png)  
 over~~
