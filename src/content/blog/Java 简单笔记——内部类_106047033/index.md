...
source: "https://blog.csdn.net/HJS1453100406/article/details/106047033"
tags:
  - '未分类'
description: '概念：内部类是类的第五个成员（属性、代码块、方法、构造器、内部类），所谓内部类，就是说允许一个类定义于另一个类的内部，前者称为内部类、后者称为外部类。'
language: 'Chinese'
---
...
**简单来说，内部类具有类和成员的特性；**  
 ![在这里插入图片描述](images/blog_migrate_7ee95f0b06d8b29230d177d5266ba481_png.png)
...
局部内部类的写法按照规格来说是这样  
 ![在这里插入图片描述](images/blog_migrate_2bd018f54e569309f3f6e3a53a86900e_png.png)  
 但是一般不这样用，那怎么用？一般这样用：  
...
输出结果：  
 ![在这里插入图片描述](images/blog_migrate_62dc36e3cd5292569407da50977594ee_png.png)  
 ps：外部类可以直接调用内部类的构造器
...
输出结果：  
 ![在这里插入图片描述](images/blog_migrate_ae45c17343ec6feb6b7bda22e87d99b6_png.png)
...
输出结果：  
 ![在这里插入图片描述](images/blog_migrate_83c2d9b533f86e24f87c48a196ec7a2c_png.png)
...
我目前关于内部类掌握的知识并不多，所以只能简单的总结了一下，  
 但是，我是个会上网的孩子。。。。。。。。。。  
 用一下一张图做了很好的总结（非原创）  
 ![在这里插入图片描述](images/blog_migrate_97e8333c23e7e57260b07802668afbe5_png.png)  
