...
 假设4:攻击者有两种策略:“攻击”和“不攻击”。“攻击”和“不攻击”的概率分别为y(0≤y≤1)和1−y。  
 根据这些假设，作者生成了决策描述图。  
 ![在这里插入图片描述](images/blog_migrate_fefad4e0bcefe57d6a36b815755b23bf_png.png)  
...
![在这里插入图片描述](images/blog_migrate_beee76a36f39d9033618b4fb646faf92_png.png)  
 ![在这里插入图片描述](images/blog_migrate_955afa3f8cae501e99183a2732a34142_png.png)
...
 攻击方更倾向于发起攻击，防御方的策略选择与主动防御系统的成本有关（这不是废话吗？？？？？）  
 ![在这里插入图片描述](images/blog_migrate_5f3acba9feb05f61d56286032e75afa0_png.png)
