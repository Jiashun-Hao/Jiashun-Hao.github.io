...
- [一、File类](#File_3)
- [二、构造器](#_17)
- - [1.File(String pathname)](#1FileString_pathname_20)
  - [2.File(String parent, String child)](#2FileString_parent_String_child_31)
  - [3.File(File parent, String child)](#3FileFile_parent_String_child_38)
  - [4.File(URI uri)](#4FileURI_uri_45)
- [三、方法](#_50)
- - [File中常用的方法](#File_52)

  
 随便说点：之前的Java数据操作都是在内存中完成，开发环境关闭以后便会消失；从这一章开始进入
**操作文件**的阶段，其核心的内容是
**IO流**；而
**File类**是IO流的前导内容；
...
**凡是与输入、输出相关的类、接口等都定义在Java.io包下**，相同的，File类便是存在于Java.io包下；  
 ![在这里插入图片描述](images/blog_migrate_8e184525056908fdfa7b9a1468c76241_png.png)  
   
  
 File类是一个特殊的类，但它具有一般类所具有的一切，其特点有如下几条：

- **File是一个类，并且构造器可以创建其对象，此对象对应着一个文件或者文件夹（文件目录）；**![在这里插入图片描述](images/blog_migrate_8a66c99b9d8950f87a7c4420cbca67d3_png.png)  
   ![在这里插入图片描述](images/blog_migrate_17591d792261e40006b34fd185ec5924_png.png)
...
前面说到File类的构造器是可以创建对象的，而对象表示的则是文件或者文件夹（文件路径），书写的格式则有四种：  
 ![在这里插入图片描述](images/blog_migrate_5b9c56a620cf35bd51b8e415afb80f30_png.png)
...
![在这里插入图片描述](images/blog_migrate_7ab36d64a8c5006ce9554c0adff546d0_png.png)
...
![在这里插入图片描述](images/blog_migrate_3c37c57008d82c91aca8a963de6c1a13_png.png)
...
我们在本地建立两个文件来测试一下，其中，Test为文件（里面输入了5个1），Test2为文件架（文件路径）；  
 ![在这里插入图片描述](images/blog_migrate_b06699ed5ec6fe9a99c426c082aa934d_png.png)
...
运行结果：  
 ![在这里插入图片描述](images/blog_migrate_0bd8d51fe8e1977e8137af26725cb1b7_png.png)  
 **补充：**  
