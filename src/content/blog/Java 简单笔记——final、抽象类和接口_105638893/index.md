...
source: "https://blog.csdn.net/HJS1453100406/article/details/105638893"
tags:
  - '未分类'
description: '有段时间没有学习Java，导致今天看自己写的代码甚至有些地方模棱两可。比如接口这一部分。写博客很大一部分原因是想着以后复习之便，也因为如此，所以将接口补上，但是因为接口需要用到抽象的一些概念，然而抽象...'
language: 'Chinese'
---
...
![在这里插入图片描述](images/blog_migrate_72ef8a4a826c7ee84f92f1e384668b2c_png.png)

##### 2、final修饰方法：该方法不能被重写；

![在这里插入图片描述](images/blog_migrate_598fa7d588a4e54f60cc2e8276393185_png.png)
...
- 用static与final同时修饰一个常量时，该常量为“全局常量”；  
   ![在这里插入图片描述](images/blog_migrate_cb31ffd9c3a0a8726abd68332b1798a1_png.png)  
   ![在这里插入图片描述](images/blog_migrate_3c9f677fa1971e45b823bbb057c8e1ae_png.png)
...
- 不可以被实例化  
   ![在这里插入图片描述](images/blog_migrate_f856e35dc6fddb38040e1d8d8c0d1fe4_png.png)
- 有构造器并且可以被定义（类都有构造器）
...
输出结果：![在这里插入图片描述](images/blog_migrate_0932bafc7adf8934d0ff63439cb6cad5_png.png)
