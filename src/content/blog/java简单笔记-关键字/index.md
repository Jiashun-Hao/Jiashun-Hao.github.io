---
title: "Java简单笔记 ——关键字"
description: "前一篇写了一些基本的理解。后来发现有些不足，改进了一些，另外最近又初步了解了一些，现在将这些总结到第二篇。 所谓的访问修饰符，就是用来修饰类(接口、抽象类)、方"
publishDate: 2020-02-07
tags: []
# 原文链接: https://blog.csdn.net/HJS1453100406/article/details/104204139
---
...
![在这里插入图片描述](./images/2d31d498e4176d8790552f821ada2a3e.png)
...
![在这里插入图片描述](./images/4b545fd741cb9c0ef28418fb346b28fb.png)
...
![在这里插入图片描述](./images/95d2251a5ef689dae16495ae4bd2dbdc.png)  
结果：  
![在这里插入图片描述](./images/0e0cd7f24657636208a27699c870d972.png)  
（2）如果文件中不止一个类，而且没有public类，文件名可与任一类名一致。  
![在这里插入图片描述](./images/7d5cc24c990d85ee51a56f3d3cab99b7.png)  
...
![在这里插入图片描述](./images/92aca2772632cb01fab7deab80f49dbc.png)  
并不是这样，其实判断Java的主类并不是去寻找public class，而是去寻找**和文件名一样的类名**它所对应的类，就是Java的主类  
![在这里插入图片描述](./images/3e00ab668110372f7ca92b928aa78a56.png)  
...
输出结果：  
![](./images/c0b0d89858ca3fa227d8bcf789044299.png)  
...
输出结果：  
![](./images/03ba1bf964174a0cf53f941859268667.png)
