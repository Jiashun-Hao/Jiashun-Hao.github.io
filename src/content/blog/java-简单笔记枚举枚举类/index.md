...
description: "- [一、枚举和枚举类](- [二、如何自定义枚举类](- - - [1、私有化构造器](    - [2、私有化属性并在构造器中初始化属性](    - [3"
...
综上步骤，自定义枚举类就算是创建完了，我们实验一下；  
 ![在这里插入图片描述](./images/b58abbd888aecd1a6454bb53c8fc9ee2.png)  
 附上完整代码：
...
同样的，我们再来测试一下，  
 ![在这里插入图片描述](./images/5011bc1c21b24eaf389b14097bc97d63.png)  
 完整代码：
...
不得不说，真的简化了好多~~  
 ...
 比如像这样：  
 ![在这里插入图片描述](./images/d0a3f6e65d7e0aedbf24fd1c362104a8.png)
...
`values`的作用是将枚举类中的对象按照数组的形式返回；  
 ![在这里插入图片描述](./images/dacd707741f066a29d11cb28ffbdc07d.png)  
 完整代码：
...
`valueOf`的作用是根据对象的名字查找对应的属性；  
 ![在这里插入图片描述](./images/17ce6806c962bbdd7b1ce94b51f34db4.png)  
 完整代码：
...
要注意的是，`valueOf（）`括号中的字符串必须是已有对象的名字，如果出错，返回的不是NULL而是直接报错；  
 ![在这里插入图片描述](./images/ab031a644e05397648f06304e3e4e9a2.png)
...
测试一下：  
 ![在这里插入图片描述](./images/8b69a1c50e9e5df5426305eb20b741ac.png)  
 可以看到，枚举类可以正常的实现接口，
...
同样的，测试一下（之前的show方法已经被注解）  
 ![在这里插入图片描述](./images/06cb2db0825e6fa6ba82bf0f61b688a3.png)  
 完整代码：
